...
public class QVolunteerWork extends EntityPathBase<VolunteerWork> {
    ...
    private static final long serialVersionUID = 1865807988L;
    ...
    public final com.study.dawheen.common.entity.QCoordinate coordinate;
    ...
    public final SetPath<com.study.dawheen.volunteer.entity.type.TargetAudience, EnumPath<com.study.dawheen.volunteer.entity.type.TargetAudience>> targetAudiences = this.<com.study.dawheen.volunteer.entity.type.TargetAudience, EnumPath<com.study.dawheen.volunteer.entity.type.TargetAudience>>createSet("targetAudiences", com.study.dawheen.volunteer.entity.type.TargetAudience.class, EnumPath.class, PathInits.DIRECT2);
    ...
    public final SetPath<com.study.dawheen.volunteer.entity.type.VolunteerType, EnumPath<com.study.dawheen.volunteer.entity.type.VolunteerType>> volunteerTypes = this.<com.study.dawheen.volunteer.entity.type.VolunteerType, EnumPath<com.study.dawheen.volunteer.entity.type.VolunteerType>>createSet("volunteerTypes", com.study.dawheen.volunteer.entity.type.VolunteerType.class, EnumPath.class, PathInits.DIRECT2);
    ...
    public QVolunteerWork(Class<? extends VolunteerWork> type, PathMetadata metadata, PathInits inits) {
        ...
        this.coordinate = inits.isInitialized("coordinate") ? new com.study.dawheen.common.entity.QCoordinate(forProperty("coordinate")) : null;
