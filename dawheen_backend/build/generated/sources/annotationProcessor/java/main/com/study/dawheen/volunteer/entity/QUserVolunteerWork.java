...
public class QUserVolunteerWork extends EntityPathBase<UserVolunteerWork> {
    ...
    private static final long serialVersionUID = -1245251095L;
    ...
    public final EnumPath<com.study.dawheen.volunteer.entity.type.ApplyStatus> status = createEnum("status", com.study.dawheen.volunteer.entity.type.ApplyStatus.class);

    public final com.study.dawheen.user.entity.QUser user;
    ...
    public QUserVolunteerWork(Class<? extends UserVolunteerWork> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.study.dawheen.user.entity.QUser(forProperty("user"), inits.get("user")) : null;
