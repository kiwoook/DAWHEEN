...
public class QOrganization extends EntityPathBase<Organization> {
    ...
    private static final long serialVersionUID = 124932611L;
    ...
    public final ListPath<com.study.dawheen.user.entity.User, com.study.dawheen.user.entity.QUser> users = this.<com.study.dawheen.user.entity.User, com.study.dawheen.user.entity.QUser>createList("users", com.study.dawheen.user.entity.User.class, com.study.dawheen.user.entity.QUser.class, PathInits.DIRECT2);

    public final ListPath<com.study.dawheen.volunteer.entity.VolunteerWork, com.study.dawheen.volunteer.entity.QVolunteerWork> workList = this.<com.study.dawheen.volunteer.entity.VolunteerWork, com.study.dawheen.volunteer.entity.QVolunteerWork>createList("workList", com.study.dawheen.volunteer.entity.VolunteerWork.class, com.study.dawheen.volunteer.entity.QVolunteerWork.class, PathInits.DIRECT2);
